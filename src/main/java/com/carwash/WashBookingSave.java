...
@WebServlet("/washBookingSave")
public class WashBookingSave extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			PreparedStatement pst = con.prepareStatement(
					"INSERT INTO wash_booking (customer_id, flat_id, vehicle_no, service_id, booking_date, status) VALUES (?, ?, ?, ?, ?, ?)");
			...
			if (flag > 0)
				...
				response.getWriter().print("Booking save failed!");
