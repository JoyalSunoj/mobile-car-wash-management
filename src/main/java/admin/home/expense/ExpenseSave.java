...
@WebServlet("/expenseSave")
public class ExpenseSave extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PreparedStatement pst = con
					.prepareStatement("INSERT INTO expenses(expense_name, expense_amount, expense_date) VALUES(?,?,?)");
